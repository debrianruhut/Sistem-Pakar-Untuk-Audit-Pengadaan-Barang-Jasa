...
<head>
  ...
  <meta name="description" content="{{ config('app.name') }} - Sistem Pakar Untuk Audit">
  <meta name="author" content="Debrian Ruhut Saragih">
  <link rel="shortcut icon" type="image/x-icon" href="{{url('images/ico.png')}}">
  <!-- CSRF Token -->
  <meta name="csrf-token" content="{{ csrf_token() }}">
  <title>{{ config('app.name') }} - Dashboard Sistem Pakar</title>
  <!-- Bootstrap core CSS-->
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright © Debrian Ruhut Saragih 2018</small>
        </div>
      </div>
    </footer>
